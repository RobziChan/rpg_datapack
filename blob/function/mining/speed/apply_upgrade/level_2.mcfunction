item modify entity @s weapon.offhand {"function":"minecraft:set_lore","entity":"this","lore":[{"text":"  +4 block break speed","color":"green","italic":false,type:"text"}],mode:"append"}
...
scoreboard players set attribute_value math 4
