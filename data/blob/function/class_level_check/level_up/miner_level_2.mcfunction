...
scoreboard players operation @s xp -= level_2 miner_level
scoreboard players set @s lvl 2

tag @s[tag=miner] add miner_level_2
tag @s[tag=miner] remove miner_level_1
